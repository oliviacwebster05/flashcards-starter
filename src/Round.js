...
class Round {
 ...
 return console.log(`** Round over! ** You answered ${this.calculatePercentCorrect()}% of the questions correctly! It took you ${minutes} minutes and ${seconds} seconds to finish the game!`);
}
}
